...
exports.addEnvelopeTransaction = async (req, res) => {
  ...
  const transactionQuery =
    'INSERT INTO transactions(description, amount, transaction_dt, envelope_id) 	VALUES($1, $2, $3, $4) RETURNING *;';
  const updateEnvelopeQuery =
    'UPDATE envelopes SET budget = budget - CAST($1 AS money) WHERE id = $2 RETURNING *;';
